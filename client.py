...
class LLMClient:
    def __init__(self, api_key: str, api_base: str, ai_model: str, prompts_dir: str = "prompts"):
    ...
    def identify_components(self, image_path: str, analysis_mode: str = "default", **prompt_kwargs):
        """
    ...
    def generate_bom_summary(self, image_path: str, analysis_mode: str = "default", **prompt_kwargs):
        """
